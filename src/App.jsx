...
const NavSidebar = ({ view, setView }) => (
  <nav className="w-16 bg-slate-900 flex flex-col items-center py-6 space-y-8 shrink-0 z-20 shadow-xl">
  ...
  <div className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10">
    <div>
      <h1 className="text-lg font-bold text-slate-800 flex items-center gap-2">
        {title}
        <span className="px-2 py-0.5 bg-amber-50 text-amber-700 text-[10px] font-bold uppercase rounded-full tracking-wider border border-amber-100">Rademan vs Rademan</span>
      </h1>
...
const App = () => {
  ...
  return (
    <div className="flex h-screen w-screen bg-slate-100 font-sans text-slate-900">
      <NavSidebar view={view} setView={setView} />
